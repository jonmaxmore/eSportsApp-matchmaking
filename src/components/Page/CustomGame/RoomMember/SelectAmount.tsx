...
const SelectAmount = ({ setShowPopup }: Props) => {
            ...
            <div className="flex flex-col items-center py-12 gap-2">
                <div className="flex flex-col items-start w-full px-28">
                    <div className="flex justify-between w-full items-center">
                        <p className="text-white uppercase text-lg font-bold ">select the amount($)</p>
                        <p className = "font-bold text-base text-primary-sky ">25$ in total</p>
                    </div>
                    {/* <Input
