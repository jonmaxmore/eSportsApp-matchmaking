                ...
                <div className="flex flex-col items-center gap-[24px] overflow-auto px-[30px] w-full">
                    <div className="flex flex-col items-center justify-center w-full gap-2   ">
                        <div className="flex items-center gap-2">
                            <p className="text-center text-lg font-light">There is an update for Battlelab CSGO client.</p>
                        </div>
                        <div className="flex items-center gap-2 pt-2">
                            <p className="text-center text-lg font-light">Would you like to CSGO update?</p>
                        </div>
                        <div className="flex items-center gap-2">
                    ...
                    <div className="flex justify-between w-full mt-6">
                        ...
                        >
                           <a href="steam://connect/13.212.68.6:27015"> TEST CONNECT</a>
                        </button>
                        ...
                        >
                            <a href={`${config.apiURL}/storage/battle_client_csgo.exe`}> INSTALL</a> 
                        </button>
                    </div>
                    ...
                    <div style={{
                        ...
                        <div>
                            <p className="mt-6 text-[#fff] text-lg font-extrabold ">STTEP INSTALL </p>
