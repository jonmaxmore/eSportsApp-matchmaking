...
const LoseCard = ({lose,setLose,loseAmount}:Props) => {
        ...
        <div className="w-[700px] h-[350px] bg-[#0a0a0a] text-black scale-75 tall:scale-100">
          ...
          <div className="flex flex-col items-center pt-12 gap-2">
            <div className="flex">
              ...
              <span className="text-primary-sky ml-1.5 font-bold "> {loseAmount/2} $ </span>
            ...
            <button
              className="mt-4  w-80 h-16 text-white font-bold rounded-sm border-2 border-primary-sky uppercase text-lg center"
              onClick={() => {
                setLose(false);
                navigate("/home")
              }}
