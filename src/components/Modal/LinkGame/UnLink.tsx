...
const UnLink = ({ setUnLink, title, gameData, elementIndex, unlinkHandler }: any) => {
    ...
    return (
        <div className="w-[700px] bg-primary-dark text-black">
            <div className="h-[75px] bg-gradient-to-r from-primary-light to-primary-dark relative p-5 flex items-center justify-center ">
                ...
                <button onClick={() => { setUnLink(false) }} className=" bg-gradient-to-br from-[#133546] to-[#0e212e] rounded-md p-1.5 absolute top-3 right-4">
            ...
            <div className="flex flex-col items-center py-12 gap-2">
                ...
                <button
                    ...
                    onClick={() => unlinkHandler(gameData, elementIndex) }
                >
                    Yes
                </button>
                <button
